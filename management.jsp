...
<div class="component-wrapper fit pb-0 mb-0">
    ...
    <div class="ppap-section mb-0 pb-0 flex-grow-1 d-flex flex-column overflow-hidden" id="projectListSection">
        <div class="section-header d-flex justify-content-between">
            ...
            <button class="action-btn" id="createProjectBtn" onclick="showCreateProjectForm()">
    ...
    <div class="ppap-section" id="operationOptionsSection" style="display: none">
        ...
        <div class="bottom-actions" style="margin-top: 20px">
            ...
            <button class="action-btn" onclick="submitProject()">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-footer bottom-actions mt-0">
                ...
                <button type="button" class="action-btn" onclick="confirmPPAPSelection()">
            ...
            <div class="modal-body" style="height: 80vh; overflow: hidden; display: flex; flex-direction: column;">
                ...
                <div id="operation-add" class="operation-block">
                    ...
                    <div class="action-buttons-row" style="display: flex; gap: 8px; flex-wrap: wrap">
                        ...
                        <button id="project-standard-ppap" class="action-btn" onclick="showStandardPPAP()">
                            <span><i class="bi bi-clipboard-check"></i></span>
                            <span><span id="size-ppap"></span> <spring:message code="standard26PPAP" /></span>
                        </button>
                        <button id="project-custom-task" class="action-btn" onclick="showCustomTask()">
                            <span><i class="bi bi-plus-circle"></i></span>
                            <span><spring:message code="customTask" /></span>
                        </button>
                        <button id="project-copy-template" class="action-btn" onclick="showCopyTemplate()">
                            <span><i class="bi bi-clipboard-check"></i></span>
                            <span><spring:message code="copyProjectTemplate" /></span>
                        </button>
                    </div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content modal-content-wide">
            ...
            <div class="modal-footer bottom-actions mt-0">
                ...
                <button type="button" class="action-btn" onclick="confirmCopyProject()">
                    <span><i class="bi bi-check-lg"></i></span>
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content modal-content-large">
            ...
            <div class="modal-footer bottom-actions mt-0">
                ...
                <button type="button" class="action-btn js-task-save" onclick="saveTaskDetailChanges()">
                    <span><i class="bi bi-floppy"></i></span>
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content modal-content-large">
            ...
            <div class="modal-footer bottom-actions mt-0">
                ...
                <button type="button" class="action-btn" id="createNextBtn" onclick="saveProjectBasicInfoModal()">
                    <span><i class="bi bi-floppy"></i></span>
...
<script src="/ppap-system/js/modules/ppap_management.js"></script>
